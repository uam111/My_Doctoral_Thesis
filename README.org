...
This is a modified version of [[https://github.com/novoid/LaTeX-KOMA-template][this thesis template]]. It has been adjusted for use in German/English theses at the Institute of Psychology II, OvG University Magdeburg. In principle, it can be used as described in the original documentation (below). However, be aware of the following differences:
...
- `git clone` this repository (best) or download it as a [[https://github.com/novoid/LaTeX-KOMA-template/archive/master.zip][ZIP file]] and extract it.
